...
import { PackageTableRow, PackageToolbar } from '../../../../sections/@dashboard/package/package';
import { useGetAllPackage } from '../../../../services/packageServices';

const TABLE_HEAD = [
  { id: 'index', label: 'SNO', align: 'left' },
  { id: 'packageName', label: 'PACKAGE NAME', align: 'left' },
  { id: 'institutionNo', label: 'INSTITUTION NO', align: 'left' },
...
export default function PackageListPage() {
  ...
  if (packageIsLoading) return <LoadingScreen />;
  ...
  const handleEditRow = (id) => {
    navigate(PATH_DASHBOARD.packages.edit(id));
  };
      ...
      <Container maxWidth={themeStretch ? false : 'lg'}>
        <CustomBreadcrumbs
          ...
          links={[
            ...
            { name: 'Package', href: PATH_DASHBOARD.packages.root },
            { name: 'Package List' },
          ]}
          action={
            <Button
              component={RouterLink}
              to={PATH_DASHBOARD.packages.new}
              variant="contained"
